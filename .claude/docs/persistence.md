...
"Entities" → "Lifecycle rules". The same caveats as V27 apply: direct SQL writers bypass the
protocol, readers never wait, and cancellation may land only after a held lock releases.
