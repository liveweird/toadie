...
import { AnnotationsFieldset, LabelsFieldset } from "./CatalogRegistryFieldsets";
...
export default function CatalogFileFormFields({
  ...
  return (
    ...
    <Stack gap="md">
      ...
      <LabelsFieldset form={form} findings={findings} />
      <AnnotationsFieldset form={form} findings={findings} />
      <SourceFieldset
