 ...
 * Entity graph's Relations `Chip.Group` both need a caption because they stand alone in the
 * toolbar's Visibility section (an always-visible second row in 2.4.1, folded behind its own
 * toggle since 2.4.2), with nothing else to say "these are blueprints"/"these are relations". `role="group"` + `aria-label={label}` keeps the accessible name identical to the
