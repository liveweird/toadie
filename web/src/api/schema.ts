...
export interface paths {
    ...
    "/api/v1/files/fetch": {
         ...
         *     Initial validation-resolver capacity exhaustion also answers `502`; its queue is
         *     bounded. Native DNS may outlive cancellation, including the JDK transport's second
         *     connection-time lookup; the deadline bounds the caller's wait, not native execution.
         */
