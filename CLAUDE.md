...
│                       `UrlFetcher`/`UrlFetcherKey`, one shared bounded pool); consumers:
│                       `POST …/files/fetch` and `POST …/entities/fetch`
