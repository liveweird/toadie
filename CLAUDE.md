...
│                       both. No other seed: custom blueprints start empty
...
│                       properties validated similarly), EntityReferences.kt (pure
...
│                       `.claude/docs/security.md` "Computed-property evaluation (jq)"),
