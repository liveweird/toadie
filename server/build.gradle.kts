...
kover {
    reports {
        verify {
            rule {
                // Line-coverage floor (actual ~96.8%, 2026-08-29 files-filters re-measure).
                minBound(96)
                // Branch-coverage floor (actual ~75.2%, 2026-08-29 files-filters re-measure; the gap to 100% is dominated
