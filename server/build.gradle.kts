...
kover {
    reports {
        verify {
            rule {
                // Line-coverage floor (actual ~92.2%, 2026-08-22).
                minBound(90)
                // Branch-coverage floor (actual ~59.7%, 2026-08-22; the gap to 100% is dominated by
                ...
                minBound(55, coverageUnits = kotlinx.kover.gradle.plugin.dsl.CoverageUnit.BRANCH)
            }
        }
    }
}
