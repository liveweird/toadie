...
kover {
    reports {
        verify {
            rule {
                // Line-coverage floor (actual ~96.2%, 2026-08-24 checkup re-measure).
                minBound(94)
                // Branch-coverage floor (actual ~73.5%, 2026-08-24 checkup re-measure; the gap to 100% is dominated by
