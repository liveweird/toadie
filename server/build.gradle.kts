...
kover {
    reports {
        verify {
            rule {
                // Line-coverage floor (actual ~97.6%, 2026-08-22).
                minBound(90)
                // Branch-coverage floor (actual ~66.4%, 2026-08-22; the gap to 100% is dominated by
                ...
                minBound(60, coverageUnits = kotlinx.kover.gradle.plugin.dsl.CoverageUnit.BRANCH)
            }
        }
    }
}
